...
int_u8 heat_elmnt_result[2]={0};
int_u8 heat_elmnt_short[2]={0};
int_u32 heat_elmnt_result_time[2]={0};
int_u8 heat_elmnt_flag[2]= {0};
...
# 1 "./uart.h" 1
# 27 "./uart.h"
int_u8 transmision_msg,time_flag=0,received=0,count,toggle=0,rx_index= 0,motor_dir_status = 0;
uart_rx_t rx_msg_buf[50]={0};
int_u8 bt_msg[50]={0};
int_u8 reply[16]={0};
int_32 stepper_count = 0;
int_32 preset[4]={0};
int_32 desired_pos = 0;
int_u8 run_preset_flag = 0;
...
void main()
{
   ...
   while(1)
   {
       ...
       while(current_time > counter && test_status == 0)
       {
           adc_update(0);
       }
  ...
  void heat_element_testing(void)
{
    ...
    int_u32 testing_elapse_time[2] = {0};
    ...
    for(i = 0 ; i < 2; i++)
    {
        ...
        testing_elapse_time[i] = counter+200;
        loop_count = 0;
...
# 112 "i2c_driver.c"
            ...
            if((adc_value[0] > 368.64) && (adc_value[0] < 409.6) && (heat_elmnt_flag[i] == 0))
            {
                heat_elmnt_result[i]= 1;
                heat_elmnt_short[i]= 1;
...
int_u8 timer_init(int_u32 delay)
{
    ...
    T1CON=0xB1;
    timer_value = (65536 -(((delay) * 20000000))/((8) * 4000 ));
...
# 417 "i2c_driver.c"
void __attribute__((picinterrupt(("")))) interrupt_isr(void)
{
